...
class PlayPauseButton extends globalThis.HTMLElement {
  ...
  #updateAttributes = (event: any) => {
    ...
    this.setAttribute("aria-label", event?.state?.isPlaying ? translate("pauseAudio") : translate("playAudio"));
  };
