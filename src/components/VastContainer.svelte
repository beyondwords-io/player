<script>
  ...
  $: adParams = vastUrlParams(vastUrl, placement, advertConsent, maxImageSize, projectId, playlistId, contentId, contentLanguage, platform, bundleIdentifier, elementIsVisible(video));
