...
const postStatuses = ["handled", "ignored-due-to-advert", "ignored-due-to-intro-outro", "ignored-due-to-scrubbing", "ignored-due-to-precedence"];
...
export const validateAnalyticsEvent = (props) => {                                   // ClickHouse Types:
  ...
  validateProperty(props, "access_tier",           s => !s || typeof s === "string");// String
