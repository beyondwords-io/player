...
const settingsManifest = [
  ...
  { key: "theme", label: "Theme", group: "Colors", control: "select", options: [null, "light", "dark", "auto"], default: "light", cleared: null, appliesTo: "default",
  ...
  { key: "accentColor", group: "Style", control: "text", default: undefined, appliesTo: "default", advanced: true, needs: "the deprecated flat SDK override; use the palette editors" },
  { key: "accentTextColor", group: "Style", control: "text", default: undefined, appliesTo: "default", advanced: true, needs: "the deprecated flat SDK override; use the palette editors" },
  ...
  { key: "variants", group: "Playback", control: "select", default: [], api: "variants", appliesTo: "default", ...csv,
    options: ["", "article", "summary", "article,summary"], format: (value) => (value || []).join(",") || "all available" },
  ...
  { key: "accessCtaUrl", group: "Access", control: "text", default: undefined, cleared: null, api: "access_tier.cta_url", appliesTo: "default" },
  ...
  { key: "agentVoice", group: "Agent", control: "select", options: bool, default: true, api: "agent_voice_enabled", appliesTo: "default" },
  { key: "agentName", group: "Agent", control: "text", default: undefined, cleared: null, api: "conversational_agent.name", appliesTo: "default" },
  { key: "agentPlaceholder", group: "Agent", control: "text", default: undefined, cleared: null, api: "agent_placeholder", appliesTo: "default" },
  // Type your own, separated by a pipe, or start from a preset. Pipes rather
  // than commas because these are sentences.
  { key: "shortcuts", group: "Agent", control: "text", default: [], cleared: [], api: "agent_shortcuts", appliesTo: "default",
    format: (value) => (value || []).join(" | "),
  ...
  { key: "agentColor", group: "Agent", control: "text", default: undefined, cleared: null, appliesTo: "default", advanced: true, needs: "the deprecated flat SDK override; use the palette editors" },
  ...
  { key: "widgetEmbedMode", group: "Widget", control: "select", options: ["auto", "audio", "audio-agent", "agent"], default: "auto", api: "widget_embed_mode", appliesTo: "default" },
  ...
  { key: "infoText", group: "Attribution", control: "text", default: undefined, cleared: null, api: "info_text", appliesTo: "default" },
  { key: "disclosureText", group: "Attribution", control: "text", default: undefined, cleared: null, api: "disclosure_text", appliesTo: "default" },
  { key: "disclosureLink", group: "Attribution", control: "text", default: undefined, cleared: null, api: "disclosure_link", appliesTo: "default" },
